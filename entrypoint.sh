...
UUID=${UUID:-'cbf66af4-f728-47d3-b79b-d0c9523a5438'}
VMESS_WSPATH=${VMESS_WSPATH:-'/cbf66af4-f728-47d3-b79b-d0c9523a5438-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/cbf66af4-f728-47d3-b79b-d0c9523a5438-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/cbf66af4-f728-47d3-b79b-d0c9523a5438-trojan'}
SS_WSPATH=${SS_WSPATH:-'/cbf66af4-f728-47d3-b79b-d0c9523a5438-shadowsocks'}
